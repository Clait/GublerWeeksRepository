...
<asp:Content ID="BodyContent" runat="server" ContentPlaceHolderID="MainContent">
   ...
   <h2>Page Links!</h2>
    ...
    <h3><asp:Label ID="Label1" runat="server" Text="Label" Width="380px">Exercise 1 - The .Net Framework </asp:Label>
        <asp:HyperLink ID="HyperLink17" target="_blank" runat="server" NavigateUrl="Instructions/01-The Net Framework_ Sp13 MIS-5050-001.pdf"><asp:Image ID="Image4" runat="server" ImageUrl="~/Instructions/webpage.png" /></asp:HyperLink>&nbsp;&nbsp;&nbsp;&nbsp;</h3><hr />
    <br />
    <br /> 
    <h3><asp:Label ID="Label2" runat="server" Text="Label" Width="380px">Exercise 2 - Visual Studio Basics </asp:Label>
        ...
        <asp:HyperLink ID="HyperLink23" runat="server" target="_blank" NavigateUrl="~/Instructions/02-Visual Studio_CRE_Instructions.pdf"><asp:Image ID="Image13" runat="server" ImageUrl="~/Instructions/File.png" valign="top"/></asp:HyperLink></h3><hr />
    ...
    <h3><asp:Label ID="Label3" runat="server" Text="Label" Width="380px">Exercise 3 - C# (Types, Objects and Namespaces) </asp:Label>
        ...
        <asp:HyperLink ID="HyperLink13" runat="server" target="_blank" NavigateUrl="~/Instructions/03-C-Sharp_CRE_Instructions.pdf"><asp:Image ID="Image1" runat="server" ImageUrl="~/Instructions/File.png" valign="top"/></asp:HyperLink></h3><hr />
    ...
    <h3><asp:Label ID="Label4" runat="server" Text="Label" Width="380px">Exercise 4 - Web Form Fundamentals</asp:Label>
        ...
        <asp:HyperLink ID="HyperLink16" runat="server" target="_blank" NavigateUrl="~/Instructions/04-Web Form Fundamentals_CRE_Instructions.pdf"><asp:Image ID="Image3" runat="server" ImageUrl="~/Instructions/File.png" valign="top"/></asp:HyperLink></h3><hr />
    ...
    <h3><asp:Label ID="Label5" runat="server" Text="Label" Width="380px">Exercise 5 - Basic Web Controls </asp:Label>
        ...
        <asp:HyperLink ID="HyperLink24" runat="server" target="_blank" NavigateUrl="~/Instructions/05-Web Controls_CRE_Instructions.pdf"><asp:Image ID="Image14" runat="server" ImageUrl="~/Instructions/File.png" valign="top"/></asp:HyperLink></h3><hr />
    ...
    <h3><asp:Label ID="Label6" runat="server" Text="Label" Width="380px">Exercise 6 - Advanced Controls </asp:Label>
        ...
        <asp:HyperLink ID="HyperLink22" runat="server" target="_blank" NavigateUrl="~/Instructions/06-Advanced Controls_CRE_Instructions.pdf"><asp:Image ID="Image12" runat="server" ImageUrl="~/Instructions/File.png" valign="top"/></asp:HyperLink></h3><hr />
    ...
    <h3><asp:Label ID="Label7" runat="server" Text="Label" Width="380px">Exercise 7 - User Controls and Master Pages </asp:Label>
        ...
        <asp:HyperLink ID="HyperLink25" runat="server" target="_blank" NavigateUrl="~/Instructions/07-User Controls Master Pages_CRE_Instructions.pdf"><asp:Image ID="Image15" runat="server" ImageUrl="~/Instructions/File.png" valign="top"/></asp:HyperLink></h3><hr />
    ...
    <h3><asp:Label ID="Label8" runat="server" Text="Label" Width="380px">Exercise 8 - ADO.NET (Advanced Data Objects) </asp:Label>
        ...
        <asp:HyperLink ID="HyperLink26" runat="server" target="_blank" NavigateUrl="~/Instructions/08-ADO_CRE_Instructions.pdf"><asp:Image ID="Image16" runat="server" ImageUrl="~/Instructions/File.png" valign="top"/></asp:HyperLink></h3><hr />
    ...
    <h3><asp:Label ID="Label9" runat="server" Text="Label" Width="380px">Exercise 9 - Component-Based Architecture </asp:Label>
                ...
                <asp:HyperLink ID="HyperLink28" runat="server" target="_blank" NavigateUrl="~/Instructions/09-Component_CRE_Instructions.pdf"><asp:Image ID="Image18" runat="server" ImageUrl="~/Instructions/File.png" valign="top"/></asp:HyperLink></h3><hr />
    ...
    <h3><asp:Label ID="Label10" runat="server" Text="Label" Width="380px">Exercise 10 - Data Binding</asp:Label>
                ...
                <asp:HyperLink ID="HyperLink30" runat="server" target="_blank" NavigateUrl="~/Instructions/10-Data Binding_CRE_Instructions.pdf"><asp:Image ID="Image20" runat="server" ImageUrl="~/Instructions/File.png" valign="top"/></asp:HyperLink></h3><hr />
    ...
    <h3><asp:Label ID="Label11" runat="server" Text="Label" Width="380px">Exercise 11 - State Management</asp:Label>
                ...
                <asp:HyperLink ID="HyperLink40" runat="server" target="_blank" NavigateUrl="~/Instructions/11-State Management_CRE_Instructions.pdf"><asp:Image ID="Image22" runat="server" ImageUrl="~/Instructions/File.png" valign="top"/></asp:HyperLink></h3><hr />
    ...
    <h3><asp:Label ID="Label12" runat="server" Text="Label" Width="380px">Exercise 12 - Validation</asp:Label>
                ...
                <asp:HyperLink ID="HyperLink44" runat="server" target="_blank" NavigateUrl="~/Instructions/12-Validation_CRE_Instructions.pdf"><asp:Image ID="Image24" runat="server" ImageUrl="~/Instructions/File.png" valign="top"/></asp:HyperLink></h3><hr />
    ...
    <h3><asp:Label ID="Label13" runat="server" Text="Label" Width="380px">Exercise 13 - Data Controls</asp:Label>
                ...
                <asp:HyperLink ID="HyperLink47" runat="server" target="_blank" NavigateUrl="~/Instructions/13-Data Controls_CRE_Instructions.pdf"><asp:Image ID="Image26" runat="server" ImageUrl="~/Instructions/File.png" valign="top"/></asp:HyperLink></h3><hr />
    ...
    <h3><asp:Label ID="Label14" runat="server" Text="Label" Width="380px">Exercise 14 - CSS, Themes, and Skins</asp:Label>
                ...
                <asp:HyperLink ID="HyperLink50" runat="server" target="_blank" NavigateUrl="~/Instructions/14-CSS Themes Skins_CRE_Instructions.pdf"><asp:Image ID="Image28" runat="server" ImageUrl="~/Instructions/File.png" valign="top"/></asp:HyperLink></h3><hr />
    ...
    <h3><asp:Label ID="Label15" runat="server" Text="Label" Width="380px">Exercise 15 - Navigation</asp:Label>
                ...
                <asp:HyperLink ID="HyperLink53" runat="server" target="_blank" NavigateUrl="~/Instructions/15-Navigation_CRE_Instructions.pdf"><asp:Image ID="Image30" runat="server" ImageUrl="~/Instructions/File.png" valign="top"/></asp:HyperLink></h3><hr />
    ...
    <h3><asp:Label ID="Label16" runat="server" Text="Label" Width="380px">Exercise 16 - Error Handling, Logging, and Tracing</asp:Label>
                ...
                <asp:HyperLink ID="HyperLink56" runat="server" target="_blank" NavigateUrl="~/Instructions/12-Validation_CRE_Instructions.pdf"><asp:Image ID="Image32" runat="server" ImageUrl="~/Instructions/File.png" valign="top"/></asp:HyperLink></h3><hr />
